...
tkis <- c("Sapatinib", "Gefitinib", "Erlotinib")
...
write.csv(new_train, file = "results/train_tki.csv", quote = F, row.names = F)
write.csv(new_targets, file = "results/targets_tki.csv", quote = F, row.names = F)
